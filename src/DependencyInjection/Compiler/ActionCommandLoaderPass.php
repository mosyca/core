...
use Mosyca\Core\Console\ActionChainCommandLoader;
 ...
 * includes the ConsoleAdapter, so every registered action appears as a
 * bin/console command with the action's name.
 *
 ...
 */
final class ActionCommandLoaderPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        $chain = new Definition(ActionChainCommandLoader::class, [
